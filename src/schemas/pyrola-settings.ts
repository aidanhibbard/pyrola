...
export const pyrolaSettingsSchema = z
  .object({
    ...
    'agent.browser.enabled': z.boolean().optional(),
    'agent.browser.allowedDomains': z.array(z.string()).optional(),
    'agent.browser.deniedDomains': z.array(z.string()).optional(),
