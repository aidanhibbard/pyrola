...
pub(crate) async fn npm_install_packages(app: &AppHandle, spec: &BuiltinLspSpec) -> Result<PathBuf, String> {
  let npm = spec
    .npm
    .as_ref()
...
pub(crate) async fn github_install(app: &AppHandle, spec: &BuiltinLspSpec) -> Result<PathBuf, String> {
  let github = spec
    .github
    .as_ref()
...
pub(crate) async fn http_archive_install(app: &AppHandle, spec: &BuiltinLspSpec) -> Result<PathBuf, String> {
  let http = spec
    .http
    .as_ref()
...
pub(crate) async fn go_install_package(app: &AppHandle, spec: &BuiltinLspSpec) -> Result<PathBuf, String> {
  let go_spec = spec
    .go
    .as_ref()
