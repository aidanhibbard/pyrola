...
use super::super::lsp_registry::{
  allowlisted_lsp_basenames, builtin_server_map, builtin_spec_by_id, root_marker_score, tier_rank,
  LspInstallKind,
};
...
pub fn resolve_lsp_servers(raw: &serde_json::Value, base: Option<HashMap<String, LspServerEntry>>) -> Option<HashMap<String, LspServerEntry>> {
  if raw.is_boolean() {
...
pub(crate) fn server_binary_available(app: &AppHandle, server_id: &str, entry: &LspServerEntry) -> bool {
...
pub(crate) async fn load_effective_servers(app: &AppHandle) -> Result<HashMap<String, LspServerEntry>, String> {
